...
\part{Определения}
    ...
    \section{Простое $k$-мерное гладкое многообразие в $\RM$}
        ...
        \begin{enumerate}
            ...
            \item $M \subset \RM$~--- простое $k$-мерное многообразие в $\RM$ (непрерывное), если оно гомеоморфно открытому множеству из $\mathbb{R}^k$.
    ...
    \section{Касательное пространство к $k$-мерному многообразию в $\RM$}
        ...
        Пусть $\Phi : O \subset \mathbb{R}^k \rightarrow \RM$~---$C^r$-параметризация $U(p) \cap M$, $p \in M$ и $\Phi(t_0) = p$. Тогда $\Phi'(t_0)(\mathbb{R}^k)$~---касательное пространство к $k$-мерному многообразию $M$ в точке $p$.
    ...
    \section{Относительный локальный максимум, минимум, экстремум}
        ...
        $M_{\Phi} = \left\{ x \in \mathbb{R}^{m + n} : \Phi(x) = 0 \right\}$
        
        $x_0 \in E$, $\Phi(x_0) = 0$~--- точка относительного локального экстремума $f$, если $\exists u(x_0) : \forall x \in U(x_0) \cap E$ $f(x) \leq f(x_0)$. 
    ...
    \section{Поточечная сходимость последовательности функций на множестве }
        ...
        $f_n : X \rightarrow \mathbb{R}$, если $\exists f : E \subset X \rightarrow \mathbb{R}$, что для любого $x_0 \in E$ $ \exists \lim\limits_{n \rightarrow +\infty} f_n(x_0) = f(x_0)$, то
    ...
    \section{Равномерная сходимость последовательности функций на множестве }
        ...
        $f_n$~--- равномерно сходится на $E$ к функции $f$ если
        
        $M_n := \sup \left| f_n(x) - f(x) \right| \xrightarrow[n \rightarrow +\infty]{} 0$.
        
        $f_n \rightrightarrows f$ на множестве $E$.
...
\part{Теоремы}
    ...
    \section{Касательное пространство в терминах векторов скорости гладких путей}
        ...
        $M$~--- $k$-мерное гладкое многообразие в $\RM$, $p \in M$, $v \in \RM$.
        
        $v \in T_p \left( M \right) \Longleftrightarrow \exists \gamma : [- \varepsilon, \varepsilon] \rightarrow M$ и $\gamma \left( [ -\varepsilon, \varepsilon ] \right) \in M$ такое, что $\gamma(0) = p$ и $\gamma'(0) = v$.
