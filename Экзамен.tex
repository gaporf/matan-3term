...
\part{Определения}
    ...
    \section{Формулировка критерия Больцано--Коши для равномерной сходимости}
        ...
        Функциональный ряд $\sum u_n$ равномерно сходится на $E \Longleftrightarrow \forall \varepsilon > 0 : \exists N : \forall m \geq n \geq N, \forall x \in E : \left| \sum\limits^m_{k = n} u_k(x) \right| < \varepsilon$.
