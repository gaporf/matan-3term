...
\part{Определения}
    ...
    \section{Касательное пространство к $k$-мерному многообразию в $\RM$}
        ...
        Пусть $\Phi : O \subset \mathbb{R}^k \rightarrow \RM$~---$C^r$-параметризация $U(p) \cap M$, $p \in M$ и $\Phi(t_0) = p$. Тогда $\Phi'(t_0) : \mathbb{R}^k \rightarrow \RM$~---касательное пространство к $k$-мерному многообразию $M$ в точке $p$.
    ...
    \section{Относительный локальный максимум, минимум, экстремум}
        ...
        $x_0 \in E$, $\Phi(x_0) = 0$~--- точка относительного локального максимума $f$, если $\exists U (x_0) : \forall x \in U(x_0) \cap E$ $f(x) \leq f(x_0)$. 
    ...
    \section{Формулировка достаточного условия относительного экстремума}
        ...
        $\Phi : E \rightarrow \mathbb{R}^n$, $a \in E : \rang \Phi'(a) = n$.
        ...
        Рассмотрим квадратичную форму $Q(h_x) = d^2 G(a, \left( h_x, \psi (h_x ) \right) )$.
        
        $Q$~--- положительно определенная, значит точка локального минимума, если отрицательно определенная~--- точка локального максимума, $Q$~--- неопределенная~--- нет экстремума.
    ...
    \section{Равномерная сходимость последовательности функций на множестве }
        ...
        $f$, $f_n : X \rightarrow \mathbb{R}$, $E \subset \mathbb{R}$, тогда $f_n$~--- равномерно сходится на $E$ к функции $f$ если
        
        $M_n := \sup \left| f_n(x) - f(x) \right| \xrightarrow[n \rightarrow +\infty]{} 0$.
    ...
    \section{Формулировка критерия Больцано--Коши для равномерной сходимости}
        ...
        Функциональный ряд $\sum u_n$ равномерно сходится на $E \Longleftrightarrow \forall \varepsilon > 0 : \exists N : \forall m \geq n \geq N, x \in E : \left| \sum\limits^m_{k = n} u_k(x) \right| < \varepsilon$.
    ...
    \section{Векторное поле}
        ...
        $V : E \subset \RM \rightarrow \RM$~--- векторное поле, где $E$~--- открытое, (по умолчанию непрерывное), гладкое.
        
    \newpage
    
    \section{Интеграл векторного поля по кусочно-гладкому пути}
    
        $V$~--- векторное поле в $E$, $\gamma$~--- кусочно-гладкий путь в $E$. Тогда
        
        $I(V, \gamma) := \int\limits^b_a \langle V \left( \gamma(t) \right), \gamma' (t) \rangle dt$~--- интеграл векторного поля $V$ по кусочно-гладкому пути $\gamma$.
...
\part{Теоремы}
    ...
    \section{Касательное пространство в терминах векторов скорости гладких путей}
        ...
        $v \in T_p(M) \subset \RM \Longleftrightarrow$ существует гладкий путь $\gamma_v : [-1, 1] \rightarrow M$, $\gamma'(0) = v$ и $\gamma(0) = p$.
    ...
    \section{Правило Лейбница дифференцирования интеграла по параметру}
        ...
        $\Phi$~--- дифференцируема на $[c, d]$ и $\Phi'(y) = \int\limits^b_a f'_y (x, y) dx$
    ...
    \section{Теорема о предельном переходе под знаком производной. Дифференцирование функционального ряда}
        ...
        $f_n \in C^1 \langle a, b \rangle$ и $f_n \rightarrow f_0$ топочечно на $\langle a, b \rangle$, $f'_n \rightrightarrows \varphi$ на $\langle a, b \rangle$. Тогда 
    ...
    \section{Теорема о дифференцировании степенного ряда. Следствие об интегрировании. Пример}
        ...
        \begin{enumerate}
            ...
            \item $(A')$ тоже равномерно сходится на $R$;
        ...
        \subsection{Следствие о бесконечной дифференцируемости}
            
            $f(z) = \sum a_n (z - z_0)^n$, $0 < R \leq +\infty$. Тогда $f \in C^{+\infty} \left( B(z_0, R) \right)$ и все производные находится с помощью почленного дифференцирования.
    ...
    \section{Простейшие свойства интеграла векторного поля по кусочно-гладкому пути}
        ...
        \begin{enumerate}
            ...
            \item Аддитивность при дроблении пути:
                ...
                $\gamma_1 := \gamma \bigg|_{[a, c]}$, $\gamma_2 := \gamma \bigg|_{[c, b]}$ и
            ...
            \item Оценка интеграла по пути:
                ...
                $\left| I \left( V, \gamma \right) \right| \leq \max\limits{x \in L} \left| V(x) \right| \cdot l (\gamma)$.
    ...
    \section{Характеризация потенциальных векторных полей в терминах интегралов}
        ...
        \begin{enumerate}
            ...
            \item Итеграл $\int\limits_{\gamma} v_1 dx_1 + \ldots + v_m dx_m$ не зависит от пути в $O$;
